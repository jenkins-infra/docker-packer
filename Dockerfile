...
ADD https://github.com/rgl/packer-plugin-windows-update/releases/download/${WINDOWS_UPDATE_VERSION}/packer-plugin-windows-update_${WINDOWS_UPDATE_VERSION}_x5.0_SHA256SUMS ./
